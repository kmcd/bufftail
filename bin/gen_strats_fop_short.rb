...
strategies = {
  'MACT' => 'Cross( C, MA(C,lookback) )',
  'MOCT' => 'Cross( LinRegSlope(ROC(C,lookback),lookback), 0)',
  'CHCT' => 'C >= HHV( C, lookback )',
  'ZSCT' => 'Cross( zscore(C,lookback), Optimize("zs",1,0,2,0.1) )',
  'MA' => 'Cross( MA(C,lookback), C )',
  'MO' => 'Cross( 0, LinRegSlope(ROC(C,lookback),lookback) )',
  'CH' => 'C <= LLV( C, lookback )',
  'ZS' => 'Cross( zscore(C,lookback), Optimize("zs",1,-2,0,0.1) )',
}
